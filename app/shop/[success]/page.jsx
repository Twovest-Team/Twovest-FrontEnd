            ...
            <SuccessCard>
                <div className="flex flex-col gap-6">
                    ...
                    <div className="border container rounded border-grey py-6 flex flex-col gap-3">
                        <h1 className="font-semibold text-primary_main text-h5" ariaLabel="200">
                            + 200
                        </h1>
                        <p
                            className="text-secondary"
                            ariaLabel="Podes fazer uso destes pontos para adquirir cupões."
                        >
                        ...
                        <p
                            ...
                            aria
                            ariaLabel=" Total de pontos: "
                        >
                            Total de pontos:{" "}
                            <span className="text-primary_main" ariaLabel="350">
                                350
                            </span>
                        </p>
                    </div>
