        ...
        <div className='min-h-screen flex-col gap-32 mx-auto '>
            ...
            <main className='container my-10 flex flex-col gap-9'>
                ...
                <div className={`container ${(selectedType === 'white' || selectedType === 'white-outlined') && 'bg-black text-white '} shadow-md px-5 py-5 w-full rounded`}>
                    ...
                    <h6 className='font-semibold mb-5 flex items-center gap-1'>Normal <CopyButton copy={templates.normal} /></h6>
                ...
                <div className={`container ${(selectedType === 'white' || selectedType === 'white-outlined') && 'bg-black text-white '} shadow-md px-5 py-5 w-full rounded`}>
                    ...
                    <h6 className='font-semibold mb-5 flex items-center gap-1'>Disabled <CopyButton copy={templates.disabled} /></h6>
                ...
                {/* NORMAL WITH LINK */}
                <div className={`container ${(selectedType === 'white' || selectedType === 'white-outlined') && 'bg-black text-white '} shadow-md px-5 py-5 w-full rounded`}>
                    <h6 className='font-semibold mb-5 flex items-center gap-1'>Normal with link <CopyButton copy={templates.withLink} /></h6>
                    <Button
                        type={selectedType}
                        ariaLabel='WRITE HERE'
                ...
                {/* fULL WIDTH */}
                <div className={`container ${(selectedType === 'white' || selectedType === 'white-outlined') && 'bg-black text-white '} shadow-md px-5 py-5 w-full rounded`}>
                    <h6 className='font-semibold mb-5 flex items-center gap-1'>Full width <CopyButton copy={templates.fullWidth} /></h6>
                    <Button
                        type={selectedType}
                        ariaLabel='WRITE HERE'
                        width='full'
                ...
                {/* CENTERED ICON */}
                <div className={`container ${(selectedType === 'white' || selectedType === 'white-outlined') && 'bg-black text-white '} shadow-md px-5 py-5 w-full rounded`}>
                    <h6 className='font-semibold mb-5 flex items-center gap-1'>Centered Icon <CopyButton copy={templates.centeredIcon} /></h6>
                    <Button
                        type={selectedType}
                        ariaLabel='WRITE HERE'
                    >
                ...
                {/* RIGHT ICON */}
                <div className={`container ${(selectedType === 'white' || selectedType === 'white-outlined') && 'bg-black text-white '} shadow-md px-5 py-5 w-full rounded`}>
                    <h6 className='font-semibold mb-5 flex items-center gap-1'>Right Icon <CopyButton copy={templates.rightIcon} /></h6>
                    <Button
                        type={selectedType}
                        ariaLabel='WRITE HERE'
                        width='full'
                ...
                {/* LEFT ICON */}
                <div className={`container ${(selectedType === 'white' || selectedType === 'white-outlined') && 'bg-black text-white '} shadow-md px-5 py-5 w-full rounded`}>
                    <h6 className='font-semibold mb-5 flex items-center gap-1'>Left Icon <CopyButton copy={templates.leftIcon} /></h6>
                    <Button
                        type={selectedType}
                        ariaLabel='WRITE HERE'
                        width='full'
                ...
                {/* FULLY ROUNDED */}
                <div className={`container ${(selectedType === 'white' || selectedType === 'white-outlined') && 'bg-black text-white '} shadow-md px-5 py-5 w-full rounded`}>
                    <h6 className='font-semibold mb-5 flex items-center gap-1'>Fully rounded <CopyButton copy={templates.rounded} /></h6>
                    <Button
                        type={selectedType}
                        ariaLabel='WRITE HERE'
                        radius='full'
                ...
                {/* ICON ONLY */}
                <div className={`container ${(selectedType === 'white' || selectedType === 'white-outlined') && 'bg-black text-white '} shadow-md px-5 py-5 w-full rounded`}>
                    <h6 className='font-semibold mb-5 flex items-center gap-1'>Only Icon - multiple sizes <CopyButton copy={templates.onlyIcon} /></h6>
