      ...
      {modalOpen && (
        <div className="user_modal">
          <div className="modal_header">
            ...
            <Buttons
              aria-label="Identificador Unico de utilizador"
          ...
          <div className="modal_body">
            ...
            <button className="button_points">
              {" "}
              <AutoModeOutlinedIcon fontSize="15px" /> Pontos & Cupões
            </button>
            <div className="div_grey-line" />
          </div>

          <div className="modal_body">
            <button className="button_submit-look">
              {" "}
              <ArrowCircleUpOutlinedIcon fontSize="15px" />
              Submeter novo look
            </button>
