      ...
      <SwiperSlide>
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="absolute text-white text-center pb-2 container">
            ...
            <h3 className="text_h3 font-semibold">Artigos com promoções até 50%</h3>
      ...
      <SwiperSlide>
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="absolute text-center text-white pb-10 container">
            <h3 className="text_h3 font-semibold ">Tens roupa que já não precisas?</h3>
            <h5 className="text_h5">Retorna-a nos pontos de recolha</h5>
      ...
      <SwiperSlide>
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="absolute text-center text-white container">
            <h3 className="font-semibold text_h3">
