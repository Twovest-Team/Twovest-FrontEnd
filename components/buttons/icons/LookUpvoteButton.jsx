...
export default function LookUpvoteButton({ upvotes, location }) {
  return (
    <div className={`absolute top-0 right-0 ${location === 'profile' ? 'w-[50px] h-[25px]' : 'w-[70px] h-[45px]'} bg-black rounded-tr-[5px]} rounded-bl-[5px] justify-center items-center inline-flex`}>
