...
const SaveLookSection = ({ collectionsData, lookId, ownerId, nextSection }) => {
  ...
  return (
    <>
      <div>
        <h6 className="font-semibold text_h6">Guardar look {lookId}</h6>
...
const NamingSection = ({ lookId, nameState, setNameState, nextSection }) => {
  ...
  return (
    <>
      <div>
        <h6 className="font-semibold text_h6">Criar nova coleção</h6>
  ...
  return (
    <>
      <div className="w-full text-center flex flex-col items-center">
        ...
        <h6 className="font-semibold mt-4 text_h6">
