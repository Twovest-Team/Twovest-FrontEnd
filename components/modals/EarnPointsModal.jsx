    ...
    return (
        <>
            ...
            <button onClick={handleClick}
                className='hidden bg-black hover:bg-dark_gray text-white sm:flex  transition-all duration-200 px-5 py-2 rounded-full text-caption gap-2 items-center font-semibold'>
            ...
            <Modal fullScreenMobile={true} noPadding={true} id={'galleryPointsModal'}>
                ...
                <div className='h-full flex flex-col'>
                    ...
                    <div className='pb-8 pt-5 flex flex-col gap-6 container'>
                        <div>
                            <h1 className="text-h5 mb-2">Ganha pontos com os teus looks</h1>
