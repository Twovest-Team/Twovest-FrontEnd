            ...
            <section className="grid grid-cols-2 gap-6">
                ...
                {filteredBrands.map((brandItem, index) => (
                    <div key={index} className="flex flex-col items-center justify-between">
                        <div className={`w-full aspect-square bg-grey_opacity_50 rounded flex items-center justify-center`}>
                        ...
                        <p key={index} className="grid mt-2 font-semibold justify-center text-center">{brandItem.name}</p>
                    </div>
                ))}
